...
- 这些值应存放在 workflow 可访问的位置，例如 Repository Secrets，或当前使用的 `react-tetris` Environment Secrets 中
...
5. Android 相关 Secrets 已在 `react-tetris` environment 中配置，或改为仓库级 Secrets
6. 远端 tag 名与当前应用版本一致
7. Release 页面权限正常
